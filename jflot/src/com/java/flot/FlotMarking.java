...
/**
 * 
 * This class defines Marking, which will be pushed to Markings
 * Marking --> { xaxis: { from: 0, to: 2 }, yaxis: { from: 10, to: 10 }, color: "#bb0000" }
 ...
 * @version 1.0
 */
public class FlotMarking extends FlotOptions {

	public FlotMarking() {
	}

	public void setYRange(FlotRange yRange) {
		put("yaxis", yRange);
	}

	public void setXRange(FlotRange xRange) {
		put("xaxis", xRange);
	}
	
	public FlotRange getYRange() {
		return (FlotRange) get("yaxis");
	}
	
	public FlotRange getXRange() {
		return (FlotRange) get("xaxis");
	}
